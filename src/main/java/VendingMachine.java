...
public class VendingMachine {
    ...
    public double fillCoinBox(int quarters, int dimes, int nickels){

        this.coin_box[QUARTER] += quarters;
        this.coin_box[DIME] += dimes;
        this.coin_box[NICKEL] += nickels;

        this.coin_box_value += (0.25 * quarters) + (0.10 * dimes) + (0.05 * nickels);
